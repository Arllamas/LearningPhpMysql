...
<h1> USANDO OPERADORES DE COMPARACIÓN </h1>
	...
	<form action="vd1601_Condic_Oper_Ternario_2.php" method= "post" Name = "datos_usuario" id = "datos_usuario">
	...
	/* Comprobamos que se ha pulsado el botón submit mediante la función de php isset() que devuelve un "1 true" si una variable
		...
		/* SUPRIMIR SOLO ESTA LÍNEA DE COMENTARIO Y MODIFICAR EL actio DE LA ETIQUETA <form>
