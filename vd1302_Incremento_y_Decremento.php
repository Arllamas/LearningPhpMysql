...
function Calcular($num1,$num2,$calculo){
	...
	}else if (!strcmp($calculo, "Incremento")){
		$num1++;
		$resultado=$num1;
		echo "<br><p class='resultado'>El resultado de incrementar 1 al primer argumento es: $resultado</p>";
	}else if (!strcmp($calculo, "Decremento")){
		$num1--;
		$resultado=$num1;
		echo "<br><p class='resultado'>El resultado de decrementar 1 al primer argumento es: $resultado</p>";
	}
}
